...
module Proxy
  module AnsibleDirector
    module ContainerRegistry
      ...
      #     cmd = "podman push #{::Proxy::AnsibleDirector::ContainerRegistry::PodmanAuth.tls_args(@cert_dir)} ..."
      #     initialize_command('bash', '-c', cmd)
      #   end
      #
      #   def close
      #     ::Proxy::AnsibleDirector::ContainerRegistry::PodmanAuth.cleanup(@cert_dir)
      #   end
      module PodmanAuth
